...
import ListCommentScreen from "../Entities/Comment/List.comment.screen";
import ShowCommentScreen from "../Entities/Comment/Show.comment.screen";
    ...
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
          ...
          />
          <Stack.Screen
          name="ShowCommentScreen"
          component={ShowCommentScreen}
          options={screenOptions}
        />
